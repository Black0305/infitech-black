...
val materialCompressedWroughtIron = MaterialRegistry.createIngotMaterial(699, "compressed_wrought_iron", 0xC8B4B4, "dull", 2, [<material:iron> * 1, <material:carbon> * 25], 9.5, 7.0, 460);
